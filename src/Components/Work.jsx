...
function Work() {
  const [images, setimages] = useState([
    ...
    { url: "https://assets-global.website-files.com/6334198f239547d0f9cd84b3/634ef0acbc45cb2f4fc5c6b2_Yahoo.png", top: "44%", left: "57%", isActive: false },
    ...
    { url: "https://assets-global.website-files.com/6334198f239547d0f9cd84b3/634ef0af108a465002975acd_Showcase%20Websites%20(1).png", top: "41%", left: "50%", isActive: false }
  ]);
  ...
  return (
    <div className="w-full mt-20">
      <div className="relative max-w-screen-xl mx-auto text-center">
        <h1 className="text-[30vw] font-medium select-none tracking-tight leading-none">work</h1>
        <div className="absolute w-full h-full top-0">
          {images.map((elem, index) =>
            elem.isActive && (
              <img
                key={index}
                className="w-60 absolute rounded-md-lg -translate-x-[50%] -translate-y-[50%]"
                src={elem.url}
