        ...
        <div className="w-full mt-20">
            <div className=" relative max-w-screen-xl  mx-auto text-center ">
                ...
                <div className="absolute w-full h-full top-0 ">
                    {images.map((elem,index) => (elem.isActive && (<img className="w-60 absolute rounded-md-lg -translate-x-[50%] -translate-y-[50%]" src={elem.url} style={{top: elem.top, left: elem.left}} alt="" />)) )}
                </div>
            </div>
        </div>
    )
